...
from loss_f import YOLO_V3_LOSS
from model import YOLO_V3, COCO_ANCHORS
...
from utils import load_checkpoint, get_bboxes, mean_average_precision, train_fn, yolov3_collate_fn
...
def init():
    ...
    """
    parser = argparse.ArgumentParser(description="YOLO V3 Training Script")
...
def main(img_dir: str,
    ...
    model = YOLO_V3(num_classes=C).to(device)

    optimizer = optim.Adam(
        model.parameters(), lr=lr, weight_decay=weight_decay)

    loss_fn = YOLO_V3_LOSS(C=C)
