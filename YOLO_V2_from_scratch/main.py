...
from loss_f import YOLO_V2_LOSS
from model import YOLO_V2, CNN_Block
...
DEFAULT_CONFIG_PATH = "./YOLO_V2_from_scratch/configs/train_config.yaml"
...
def init():
    ...
    """
    # Create parser
    parser = argparse.ArgumentParser(description="YOLO V2 Training Script")
...
def main(img_dir: str,
    ...
    model = YOLO_V2(num_classes=20).to(device)
    
    optimizer = optim.Adam(
        model.parameters(), lr=lr, weight_decay=weight_decay)
    
    loss_fn = YOLO_V2_LOSS()
